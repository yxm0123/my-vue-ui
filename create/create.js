...
process.stdin.on('data', async chunk => {
    ...
    // Vue页面组件路径 可根据实际情况修改
    const componentVuePath = resolve('../packages', `${inputName}/src`);
    // 创建vue文件
    const vueFile = resolve(componentVuePath, `${inputName}.vue`);
    // 入口文件
    ...
    if (hasComponentExists) {
        ...
        await dotExistDirectoryCreate(componentVuePath)
